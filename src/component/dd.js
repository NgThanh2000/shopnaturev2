...
//     }
//     const displayUsers = products.slice(pagesVisited, pagesVisited + usersperPage)
//         .map((product) => (
...
//                             <Link to="/Cart"><button className="product-item-img-btn" onClick={() => this.props.addtoCartSuccess(product)} >ADD TO CART</button> </Link>
//                         </div>
//                     ) : (
//                         <div className="product-item-img">
//                             <Link to={`/${product.name}/${product.id}`}><img src={product.image.sourceUrl} alt="" />
...
//     return {
//         addtoCartSuccess: item => dispatch(addtoCartSuccess(item))
